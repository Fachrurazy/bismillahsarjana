...
<script>
    ...
    function calculateAndDisplayRoute(directionsService, directionsDisplay) {
        ...
        //alert(datalokasi);
        // for (i in datalokasi) {
        //         if(datalokasi[i]['Nama_Cabang'] == 'Pabrik')
        //         {
        //             alert(datalokasi[i]['Latitude'] + ',' datalokasi[i]['Longitude']);
        //         }
        //     }
        const arrLokasi = [];

        for (i in datalokasi) {
            arrLokasi[i][1].push(datalokasi[i]['Nama_Cabang']);
            arrLokasi[i][2].push(datalokasi[i]['Latitude']);
            arrLokasi[i][3].push(datalokasi[i]['Longitude']);
            arrLokasi[i][4].push(datalokasi[i]["Latitude"] + "," + datalokasi[i]["Longitude"]);
        }
    ...
    document.getElementById("dvBahan").innerHTML = "Rp." + totalbahan;
    }
